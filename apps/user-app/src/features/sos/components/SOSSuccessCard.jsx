...
import { CheckCircle, Users, Zap, MapPin } from 'lucide-react'
...
const SOSSuccessCard = ({ result, volunteer, onResolve, onCancel }) => {
    ...
    >
      ...
      `}>
        <motion.div
          ...
          transition={{ repeat: isAccepted ? 0 : Infinity, duration: 2 }}
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-green-100 rounded-full flex items-center
                            justify-center text-xl font-bold text-green-600">
              {volunteer.name?.[0]}
            </div>
            <div>
