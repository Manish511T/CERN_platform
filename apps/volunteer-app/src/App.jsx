...
const PageLoader = () => (
  <div className="min-h-screen flex items-center justify-center bg-slate-50">
    <div
      className="w-8 h-8 border-4 border-green-500 border-t-transparent
  ...
  useEffect(() => {
    const restore = async () => {
      try {
        ...
        // Ensure this app only restores VOLUNTEER sessions
        if (user.role !== "volunteer") {
          console.log(
            "Non-volunteer session found in volunteer app — ignoring",
          );
